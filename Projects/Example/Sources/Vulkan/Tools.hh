...
struct InputData {
    Cell::Mathematics::Vector3* position = nullptr;
    float* timeMilliseconds = nullptr;
};
...
CELL_FUNCTION_INTERNAL void VulkanToolsGenerateRenderCommands(const uint32_t drawCount,
