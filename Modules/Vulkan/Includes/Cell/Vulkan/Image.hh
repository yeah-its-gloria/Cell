...
public:
    ...
    CELL_FUNCTION_TEMPLATE VkImage GetHandle() { return this->image; }

    // Returns a handle to the underlying image view.
    CELL_FUNCTION_TEMPLATE VkImageView GetViewHandle() { return this->view; }

    // Returns a handle to the underlying sampler.
    CELL_FUNCTION_TEMPLATE VkSampler GetSamplerHandle() { return this->sampler; }
