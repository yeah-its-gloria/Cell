...
CELL_FUNCTION_INTERNAL CELL_INLINE VkSurfaceFormatKHR selectFormat(const VkSurfaceFormatKHR* CELL_NONNULL formats, const uint32_t count) {
...
CELL_FUNCTION_INTERNAL CELL_INLINE VkPresentModeKHR selectPresentMode(const VkPresentModeKHR* CELL_NONNULL modes, const uint32_t count) {
    for (uint32_t index = 0; index < count; index++) {
