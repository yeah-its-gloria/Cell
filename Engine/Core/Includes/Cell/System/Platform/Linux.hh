...
#include <Cell/System/Platform/Linux/WaylandProtocols/idle-inhibit-client-protocol.h>
#include <Cell/System/Platform/Linux/WaylandProtocols/xdg-decoration-client-protocol.h>
#include <Cell/System/Platform/Linux/WaylandProtocols/xdg-shell-client-protocol.h>
...
public:
    ...
    CELL_FUNCTION static void Start(const EntryFunction entry, const bool needsWindow);
...
private:
    ...
    CELL_FUNCTION_INTERNAL static void
    WaylandKeyboardModifiers(void* data, struct wl_keyboard* keyboard, const uint32_t serial, const uint32_t modsDepressed, const uint32_t modsLatched, const uint32_t modsLocked,
